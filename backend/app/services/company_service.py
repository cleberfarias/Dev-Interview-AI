...
def create_company(user: dict, payload: CompanyCreateRequest) -> CompanyAccessContext:
    ...
    company = company_repository.upsert_company(
        company_id,
        {
            ...
            "financeName": getattr(payload, "financeName", None),
            "financeEmail": getattr(payload, "financeEmail", None),
            "hrName": getattr(payload, "hrName", None),
            "hrEmail": getattr(payload, "hrEmail", None),
            "createdAt": ts,
            "updatedAt": ts,
        },
        merge=False,
