...
import type { InterviewConfig, LanguageCode, PlanType, Seniority, Track } from '../../../shared/types';
        ...
        {step === 1 && (
          <div className="space-y-8 animate-in slide-in-from-right-8 duration-300">
            <header>
              ...
              <p className="text-slate-400 text-sm mt-1">O plano Elite oferece sessao estendida e coach por voz.</p>
            </header>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-[10px] text-indigo-300/60 font-bold uppercase mt-1">Mais tempo • Coach por voz</p>
                </div>
